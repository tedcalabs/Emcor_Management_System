    ...
    <div class="item item-20">
        <div class="card edit-info">
            <div class="card-header u_info">
                ...
                <a href="{{ route('getBrownSchedBl.sched') }}" class="close_bot">Close</a>
            </div>
        
            <form method="POST" action="{{ route('maintenancesbwynbrown.update', $data->id) }}" enctype="multipart/form-data">
                @csrf
                @method('PUT')
                <div class="row">
                    <div class="row">
