    ...
    <div>
        <div class="header-blue">
            <nav class="navbar navbar-light navbar-expand-md navigation-clean-search">
                <div class="container-fluid"><a class="navbar-brand" href="{{ route('login') }}">EMCOR Servicing Request System</a><button data-toggle="collapse" class="navbar-toggler" data-target="#navcol-1"><span class="sr-only">Toggle navigation</span><span class="navbar-toggler-icon"></span></button>
                ...
                <div class="row">
                  ...
                  <div class="card">
                     ...
                     <h2>Manager Login</h2>
                      ...
                      <div class="card-body">
                          <form method="POST" action="{{route('branchb.login')}}">
