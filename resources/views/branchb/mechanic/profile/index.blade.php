          ...
          <div class="row mb-2">
            ...
            <div class="col-sm-6">
              <ol class="breadcrumb float-sm-right">
                <li class="sech">Mechanic Profile</li>
              </ol>
            </div>
          </div>
        </div><!-- /.container-fluid -->
      ...
      <section class="content">
        <div class="container-fluid">
          <div class="row">
              ...
              <div class="card card-profile">
                  <div class="card-body box-profile">
                      <div class="text-center">
                          ...
                          <form method="POST" action="{{ route('mechanicbywn.mecphoto') }}" enctype="multipart/form-data">
                              @csrf
                              @method('PUT')
                ...
                <div class="card-body">
                  <div class="tab-content">
                    <div class="active tab-pane" id="personal_info">
                      <form class="form-horizontal" method="POST" action="{{ route('mechanicbywn.UpdateInfo') }}" id="SecInfoForm">
            ...
            @endif  
                <form class="form-horizontal" method="POST" action="{{ route('mechanicbywn.changepass') }}"  id="changePasswordAdminForm">
                    @csrf
                    <div class="form-group row">
