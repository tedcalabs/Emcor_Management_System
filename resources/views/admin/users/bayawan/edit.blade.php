                   ...
                   <a href="{{route('usersbyn.index')}}" class="close_bot">Close</a>
                    ...
                    <div class="row">
                            ...
                            <div class="col-4  form-group">
                                ...
                                <div class="mt-1">
                                    <input type="email" id="email" name="email" value="{{ $usersbyn->email }}"
                         ...
                         <div class="row">
                            <div class="col-4  form-group">
                                ...
                                <div class="mt-1">
                                <input type="text" id="role" name="role" value="{{ $usersbyn->role}}"
                    ...
                    <div class="col-4  form-group">
                        ...
                        <div class="mt-1">
                        <input type="text" id="status" name="status" value="{{ $usersbyn->status}}"
