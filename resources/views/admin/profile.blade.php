    ...
    <section class="content">
      <div class="container-fluid">
        <div class="row">
          ...
          @endif  
              <form class="form-horizontal" method="POST" action="{{ route('adminCpass') }}"  id="changePasswordAdminForm">
                  @csrf
                  <div class="form-group row">
                ...
                <div class="form-group row">
                  ...
                  <div class="col-sm-10">
                    <input type="password" class="form-control" placeholder="ReEnter new password" name="password_confirmation">
                    <span class="text-danger error-text cnewpassword_error"></span>
                  </div>
                </div>
                <div class="form-group row">
                  <div class="offset-sm-2 col-sm-10">
                    <button type="submit" class="btn btn-success text-black">Update Password</button>
                  </div>
                </div>
              </form>
            </div>
