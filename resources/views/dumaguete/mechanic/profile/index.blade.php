      ...
      <section class="content">
        <div class="container-fluid">
          <div class="row">
                ...
                <div class="card-body">
                  <div class="tab-content">
                    <div class="active tab-pane" id="personal_info">
                      <form class="form-horizontal" method="POST" action="{{ route('mechanic.UpdateInfo') }}" id="SecInfoForm">
            ...
            @endif  
                <form class="form-horizontal" method="POST" action="{{ route('mechnanic.changepass') }}"  id="changePasswordAdminForm">
                    @csrf
                    <div class="form-group row">
