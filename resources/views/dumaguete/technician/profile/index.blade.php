      ...
      <section class="content">
        <div class="container-fluid">
          <div class="row">
                ...
                <div class="card-body">
                  <div class="tab-content">
                    <div class="active tab-pane" id="personal_info">
                      <form class="form-horizontal" method="POST" action="{{ route('techUpdateInfo') }}" id="SecInfoForm">
            ...
            @endif  
                <form class="form-horizontal" method="POST" action="{{ route('tech.cpass') }}"  id="changePasswordAdminForm">
                    @csrf
                    <div class="form-group row">
