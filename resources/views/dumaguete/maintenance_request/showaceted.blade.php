    ...
    <div class="item item-25">
        ...
        <div class="card">
            <div class="card-body">
                ...
                <a href="{{ route('accept') }}" class="close close-icon" aria-label="Close">
                ...
                <div class="row">
                    <div class="col-md-6">
                        <ul class="list-group list-group-flush">
                            ...
                            <li class="list-group-item"><strong>Service Duration Date and Time:</strong> {{ \Carbon\Carbon::parse($data->task_due_date)->format('d/m/Y g:i:s A')}}</li>
